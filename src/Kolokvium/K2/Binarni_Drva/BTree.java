...
public class BTree<E> {
    ...
    public BNode<E> findNodeRecursive(E elem) {
        return findNodeRecursiveR(root, elem);
    }

    private BNode<E> findNodeRecursiveR(BNode<E> node, E elem) {
        if (node == null) {
            return null;
        }
        ...
        BNode<E> leftSearch = findNodeRecursiveR(node.left, elem);
        if (leftSearch != null) {
            return leftSearch;
        }
        return findNodeRecursiveR(node.right, elem);
    }
    ...
    public BNode<E> findNodeNonRecursive(E elem) {
